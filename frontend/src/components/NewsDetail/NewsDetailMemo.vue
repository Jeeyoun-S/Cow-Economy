<template>
  <v-sheet class="pa-5">
    ...
    <NewsDetailMemoItem></NewsDetailMemoItem>
...
<script>
import NewsDetailMemoRegister from "@/components/NewsDetail/NewsDetailMemoRegister.vue";
import NewsDetailMemoItem from "@/components/NewsDetail/NewsDetailMemoItem.vue";
  ...
  methods: {
    getSelectedText() {
      ...
      if (text.length > 0) {
        ...
        console.log("WWW", nodeIndex, textNode);
